...
function CardWeb() {
  return (
    <div className="grid md:grid-cols-2 gap-4 md:gap-10">
      ...
      <Card imageUrl={JustTravel} title="Design by Naufal@array.id" toUrl="https://trihartonoo.github.io/Arrayid-MSTSKP/" toGithub="" />
      <Card imageUrl={RumahImpian} title="Design by Me" toUrl="https://trihartonoo.github.io/Arrayid-MSTSKP/" toGithub="" />
    </div>
  );
}
