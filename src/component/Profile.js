...
function Profile() {
  return (
    <div id="Profile" className="pt-20 pb-10 md:pt-28 lg:pt-36 px-setting flex flex-col-reverse md:flex-row items-center justify-between gap-4 md:gap-10 lg:gap-20 group ">
