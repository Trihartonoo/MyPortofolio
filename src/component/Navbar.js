...
function Navbar() {
  ...
  return (
    ...
    <nav className={navbar ? 'bg-colorBackground dark:bg-gray-900/60 shadow-md duration-1000 w-full h-14 md:h-16 fixed z-20' : 'bg-transparent w-full h-14 md:h-16 fixed z-20'}>
