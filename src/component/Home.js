...
function Home() {
  ...
  return (
    <>
      <div className="dark:bg-gray-900 overflow-x-hidden bg-colorBackground text-gray-800  appearance-none dark:text-slate-200 transition duration-500 flex items-center justify-center" id="Home">
        <div className={coba}>
